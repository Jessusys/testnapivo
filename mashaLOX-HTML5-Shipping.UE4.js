...
var Module = {
	...
	UE4_indexedDBName: 'UE4_assetDatabase_mashaLOX', // this should be an ascii ID string without special characters that is unique to the project that is being packaged
	UE4_indexedDBVersion: 202304090552, // Bump this number to invalidate existing IDB storages in browsers.
};
...
Module.arguments = ['../../../mashaLOX/mashaLOX.uproject','-stdout',];
...
//	}
	...
	function withIndexedDB(db) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Jessusys/testnapivo/f4a877104b01e9f366a8e04f066d4658a24dbcbe/UE4Game-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/Jessusys/testnapivo/73a6318439ffd272da057a0a9c2f540699615082/mashaLOX-HTML5-Shipping.data.js'));
